- dashboard: overview
  ...
  - name: campaign_performance
    ...
    model: facebook
    explore: ad_insights
    dimensions: [campaigns.name, ad_insights.objective]
  ...
  - name: avg_frequency_by_objective
    ...
    model: facebook
    explore: ad_insights
    dimensions: [ad_insights.objective]
